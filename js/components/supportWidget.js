...
export function renderSupportWidget(container) {
  ...
  container.innerHTML = `
    ...
    <a href="https://wa.me/923001234567?text=Hi%20KREID%20Team!%20I%20have%20a%20question%20about%20your%20products." 
       ...
       style="background: #25d366; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 24px rgba(37,211,102,0.45); transition: transform 0.25s ease;">
